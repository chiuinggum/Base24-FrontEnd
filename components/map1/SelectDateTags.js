...
export default function SelectDateTags(props) {
    const {
        markerClicked,
        setMarkerClicked,
        markers,
    ...
    useEffect(() => {
        const fetchDateName = async () => {
            const response = await axios.get(`${process.env.NEXT_PUBLIC_DATES_URL}/get/marker/${markerClicked}`);
    ...
    useEffect(() => {
        ...
        const updateMarkerDates = async () => {
            const response = await axios.put(
                `${process.env.NEXT_PUBLIC_DATES_URL}/update/markers`,
                {
                    dates: dates,
                    dateName: dateName,
                    marker_id: markerClicked
                },
